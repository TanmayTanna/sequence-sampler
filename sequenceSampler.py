...
optional.add_argument('-z', '--noSampling', help='percentage probability of features in reference to not have any sampling', dest='noseq', default=50)
optional.add_argument('-q', '--outFile', help='name of output file', dest='outFile', default='NULL')
